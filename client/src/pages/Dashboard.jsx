        ...
        <div className='px-5 flex justify-between items-center'>
          ...
          <div className='flex items-center gap-3'>
            ...
            <div className='relative group'>
              <img className='w-8 border rounded-full ' src={assets.company_icon} atl="" />
              <div className='absolute hidden group-hover:black top-0 right-0 z-10 text-black rounded pt-12'>
