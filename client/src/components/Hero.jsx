...
const Hero = () => {
  ...
  return (
    <div className='container 2xl:px-20 mx-auto my-10'>
      <div className='bg-gradient-to-r from-purple-800 to-purple-950 text-wite py-16 text-center mx-2 rounded-xl'>
      ...
      <div className='broder border-gray-300 shadow-md mx-2 mt-5 p-6 rounded-md flex '>
